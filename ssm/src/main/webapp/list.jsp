	...
	<div class="layui-layout-admin">
		...
		<div class="layui-body">
			...
			<form class="layui-form">
				<div class="layui-form-item" style="padding: 30px; display: none;">
					...
					<div class="layui-inline">
						<div class="layui-input-inline">
							<input type="text" name="email" autocomplete="off"
								placeholder="请输入邮箱号" class="layui-input" maxlength="20">
						</div>
					</div>
					<div class="layui-inline">
						<div class="layui-input-inline">
							<input type="text" name="address" autocomplete="off"
								placeholder="请输入籍贯信息" class="layui-input" maxlength="10">
						</div>
					</div>
					<div class="layui-inline">
						<div class="layui-input-inline">
					...
					<div class="layui-inline">
						<button class="layui-btn layui-icon layui-icon-search" lay-submit
							lay-filter="LAY-user-back-search">搜索</button>
						<button type="reset"
			...
			<script type="text/html" id="toolbarDemo">
                        <div class="layui-btn-container">
                            ...
                            <button type="button" class="layui-btn layui-btn-warm" onclick="$('.layui-form-item').css('display') == 'none' ? $('.layui-form-item').show('fast') : $('.layui-form-item').hide('fast')"><i
                            class="layui-icon layui-icon-search">点击搜索</i></button>
                        </div>
                    </script>
			...
			<script type="text/html" id="edit">
                        ...
                        <button class="layui-btn layui-btn-warm layui-btn-sm " lay-event="edit" href="${pageContext.request.contextPath}/edit"><i

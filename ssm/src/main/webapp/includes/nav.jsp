...
<div class="layui-header">
	...
	<ul class="layui-nav layui-layout-left">
		<li class="layui-nav-item"><a
			...
			class="layui-icon layui-icon-home" href="#">主页</a></li>
		<li class="layui-nav-item"><a
			class="layui-icon layui-icon-template"
			href="${pageContext.request.contextPath}/user/list">用户信息管理</a></li>
	...
	<ul class="layui-nav layui-layout-right">
		...
		<li class="layui-nav-item"><a
			href="${pageContext.request.contextPath}/loginout">注销</a></li>
	</ul>
</div>
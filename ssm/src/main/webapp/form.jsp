		...
		<div class="layui-body">
			...
			<div class="layui-card">
				<div class="layui-card-header">
					<i class="layui-icon layui-icon-file-b">基本信息</i>
				</div>
				<div class="layui-card-body layui-main">
					<form class="layui-form layui-form-pane">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" class="layui-input" name="id"
									lay-verify="required" placeholder="自定义用户编号" maxlength="5" />
							</div>
							<label class="layui-form-label layui-required">用户名</label>
							<div class="layui-input-inline">
								<input type="text" class="layui-input" required name="username"
									lay-verify="required" placeholder="请输入用户名" maxlength="10" />
							</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="tel" maxlength="11" required name="phone"
									placeholder="请输入手机号" lay-verify="required|phone"
									autocomplete="off" class="layui-input">
							</div>
							<label class="layui-form-label">邮箱</label>
							<div class="layui-input-inline">
								<input type="email" class="layui-input" required name="email"
									lay-verify="required" placeholder="请输入邮箱号" maxlength="20" />
							</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" class="layui-input" maxlength="2" required
									name="fork" lay-verify="required" placeholder="请输入民族" />
							</div>
						</div>
						<div style="padding-left: 300px;">
							<div class="layui-input-block">
								<button class="layui-btn" lay-submit lay-filter="formDemo">
									<i class="layui-icon layui-icon-release">立即提交</i>
								</button>

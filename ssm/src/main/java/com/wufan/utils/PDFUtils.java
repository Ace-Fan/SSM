...
public class PDFUtils extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        ColumnText.showTextAligned(writer.getDirectContent(),
                Element.ALIGN_LEFT, PDFUtils.blankPhrase,
                document.left(), top, 0);
        //生成左侧页眉
        ColumnText.showTextAligned(writer.getDirectContent(),
        ...
        //生成页脚页数
        ColumnText.showTextAligned(writer.getDirectContent(),
                Element.ALIGN_CENTER, new Phrase(String.valueOf(document.getPageNumber()),PDFUtils.font),
                document.right(), document.bottomMargin(), 0);
    }
